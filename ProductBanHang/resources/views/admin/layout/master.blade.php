                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-success">
                                        <div class="menu-header-image opacity-1"
                                            style="background-image: url('doshboard/assets/images/dropdown-header/abstract3.jpg');">
                                        </div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="front/img/user/{{Auth::user()->avatar ?? '_default-user.png'}}"
                                                alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle"
                                                                        src="front/img/user/{{Auth::user()->avatar ?? '_default-user.png'}}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
