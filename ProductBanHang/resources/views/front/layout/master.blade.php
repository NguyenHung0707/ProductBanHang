            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        ...
                        <li>Email: hung0707@gmail.com</li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-text">
                        Copyright @<script>document.write(new Date().getFullYear())</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="DucOnline.vn" target="_blank"></a>
                    </div>
